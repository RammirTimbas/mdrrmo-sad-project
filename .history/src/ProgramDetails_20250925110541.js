...
import {
  ...
  where,
            <div
              className={`tab ${activeTab === "attendance" ? "active" : ""} ${(isUserApproved ||
                userRole === "admin" ||
                userRole === "trainer" ||
                requestorType?.toLowerCase() === "facilitator" ||
                (userRole === "user" && userId === requestorId && requestorType?.toLowerCase() === "facilitator")
              )
                ? ""
                : "disabled"
                }`}
            ...
            >
              {userRole === "user" &&
                requestorType?.toLowerCase() !== "facilitator" && !(userId === requestorId && requestorType?.toLowerCase() === "facilitator")
                ? "Your Attendance"
                : "Attendance"}
            </div>
  FaChalkboardTeacher,
            ...
            {activeTab === "attendance" && (
              <div className="table-container bg-white shadow-lg rounded-lg p-4 sm:p-6">
                <div className="attendance-tab">
                  {(userRole === "admin" || userRole === "trainer" || (requestorType?.toLowerCase() === "facilitator" && userId === requestorId) || (userRole === "user" && userId === requestorId && requestorType?.toLowerCase() === "facilitator")) ? (
                    <div>
