        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 place-items-center">
          {getDisplayedPrograms().length > 0 ? (
            getDisplayedPrograms().map((program) => (
              <div
                key={program.id}
                className="bg-white w-full max-w-xs rounded-2xl border border-gray-200 shadow-md overflow-hidden hover:shadow-lg transform transition duration-300 flex flex-col h-[500px]"
              >
