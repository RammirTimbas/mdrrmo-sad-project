        ...
        adminsData.length > 0 ? (
          <div className="overflow-x-auto">
            <table className="min-w-full border border-gray-300 rounded-lg overflow-hidden">
              <thead className="bg-blue-100 text-gray-700">
                <tr>
                  <th className="px-4 py-2 text-sm font-semibold text-left border-b">Name</th>
                  <th className="px-4 py-2 text-sm font-semibold text-left border-b">Profile</th>
                  <th className="px-4 py-2 text-sm font-semibold text-left border-b">Actions</th>
                </tr>
              </thead>
              <tbody>
                {adminsData.map((user) => (
                  <tr key={user.id} className="hover:bg-gray-50">
                    <td className="px-4 py-2 border-b text-sm">{user.name}</td>
                    <td className="px-4 py-2 border-b text-sm">{user.profile}</td>
                    <td className="px-4 py-2 border-b text-sm flex space-x-2">
                      <button
        ...
        trainersData.length > 0 ? (
          <div className="overflow-x-auto">
            <table className="min-w-full border border-gray-300 rounded-lg overflow-hidden">
              <thead className="bg-blue-100 text-gray-700">
                <tr>
                  <th className="px-4 py-2 text-sm font-semibold text-left border-b">Trainer Name</th>
                  <th className="px-4 py-2 text-sm font-semibold text-left border-b">Profile</th>
                  <th className="px-4 py-2 text-sm font-semibold text-left border-b">Actions</th>
                </tr>
              </thead>
              <tbody>
                {trainersData.map((trainer) => (
                  <tr key={trainer.id} className="hover:bg-gray-50">
                    <td className="px-4 py-2 border-b text-sm">{trainer.trainer_name}</td>
                    <td className="px-4 py-2 border-b text-sm">trainer</td>
                    <td className="px-4 py-2 border-b text-sm flex space-x-2">
                      <button
