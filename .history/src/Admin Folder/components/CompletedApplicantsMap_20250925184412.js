      ...
      if (docSnap.exists()) {
        ...
        applicantsList.forEach((applicant) => {
          ...
          const totalPopulation =
            populationData[municipality]?.totalPopulation ?? "N/A";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {Object.keys(municipalityStats).map((municipality) => {
                ...
                const hasMunicipalityPopulation =
                  (municipalityData.totalPopulation !== null &&
                    municipalityData.totalPopulation !== undefined &&
                    municipalityData.totalPopulation !== "N/A") ||
                  (municipalityData.total_population !== null &&
                    municipalityData.total_population !== undefined &&
                    municipalityData.total_population !== "N/A");
