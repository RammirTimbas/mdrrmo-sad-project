    ...
    <div>
      ...
      {loading ? (
        ...
        <div>
          ...
          {/* Coverage Thresholds & Messages Card */}
                ...
                {(coverageConfig.municipality || [])
                  ...
                  .map((item, idx) => (
                    <div key={idx} className="flex items-center gap-2 mb-2">
                      ...
                      <span className="w-16 p-1 border rounded bg-white text-center">{item.threshold}</span>
                      <span className="flex-1 p-1 border rounded bg-white">{item.message}</span>
                    </div>
                  ))}
              </div>
              {/* Barangay thresholds */}
