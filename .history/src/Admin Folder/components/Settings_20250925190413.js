      ...
      {activeTab === "viewConfig" && (
        <div className="p-6 bg-white shadow-lg rounded-lg">
          ...
          <div className="space-y-4">
            {/* Accordion State - moved to top-level */}
...
// AccordionItem component and openSection state moved to top-level of Settings

// ...existing code...

// Place this above the Settings component definition:
...
// Inside the Settings component, add this at the top:
