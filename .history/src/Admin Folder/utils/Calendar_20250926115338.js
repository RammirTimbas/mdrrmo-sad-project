...
const Calendar = ({ programs, mobile = false, disableEventClick = false }) => {
  ...
  return (
    <div className="p-0 sm:p-6 max-w-7xl mx-auto flex flex-col items-center justify-center min-h-screen" style={{ background: 'linear-gradient(135deg, #e0e7ff 0%, #f0fdfa 100%)', minHeight: '100dvh' }}>
      <div className="w-full flex justify-between items-center mb-4 px-4 sm:px-0">
