...
const Calendar = ({ programs, mobile = false, disableEventClick = false }) => {
  ...
  return (
    <div className="p-4 sm:p-6 max-w-7xl mx-auto" style={{ background: 'linear-gradient(135deg, #e0e7ff 0%, #f0fdfa 100%)', minHeight: 'fit-content' }}>
      ...
      <div className="rounded-3xl shadow-2xl bg-white/70 backdrop-blur-md p-2 sm:p-6 transition-all duration-500 flex justify-center">
        <FullCalendar
