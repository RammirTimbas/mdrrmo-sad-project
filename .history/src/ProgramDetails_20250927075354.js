    ...
    <div className="program-details-fullscreen">
      <div className="program-details-content">
        ...
        <div className="flex flex-wrap gap-3 mt-6">
          ...
          {/* Show QR Code Button - For Trainers and Facilitators */}
          ...
          {/* Program Requestor/Facilitator Actions */}
          {(isUserRequestor || (userRole === "user" && requestorType?.toLowerCase() === "facilitator")) && (
            <>
              <button
