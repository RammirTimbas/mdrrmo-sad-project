      ...
      <div className="program-details-content">
        ...
        <div className="program-details-container">
          ...
          <div className="tab-content">
            {(userRole === "user" || userRole === "trainer" || requestorType?.toLowerCase() === "facilitator") && (
              <>
                {activeTab === "approved" && (
            ...
            {(userRole === "admin" || requestorType?.toLowerCase() === "facilitator") && (
              <>
                {activeTab === "approved" && (
            ...
            {activeTab === "attendance" && (
              <div className="table-container bg-white shadow-lg rounded-lg p-4 sm:p-6">
                <div className="attendance-tab">
                  {(userRole === "admin" || userRole === "trainer" || requestorType?.toLowerCase() === "facilitator") ? (
                    <div>
