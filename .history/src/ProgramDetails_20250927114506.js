    ...
    <div className="program-details-fullscreen">
      <div className="program-details-content">
        ...
        <div className="flex flex-wrap gap-3 mt-6">
          ...
          {/* Show Invite/Share buttons only for requestor */}
          {isUserRequestor && (
            <>
              <button
          ...
          {/* Show QR Code button only for trainers and facilitators */}
          {(userRole === "trainer" || (userRole === "user" && requestorType === "facilitator")) && (
            <button
