...
export default function EnterPin({ onSubmit, error, onReturn }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 px-4 pointer-events-none">
      <motion.form
        onSubmit={handleSubmit}
        autoComplete="off"
        className="rounded-2xl shadow-lg p-8 w-full max-w-sm flex flex-col items-center gap-6 sm:p-8 sm:max-w-sm md:p-10 md:max-w-md lg:p-12 lg:max-w-lg bg-transparent pointer-events-auto"
