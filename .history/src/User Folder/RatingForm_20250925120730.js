    ...
    <div style={{
      ...
      <div style={{
        ...
        <button
          ...
          onClick={()=>{setAnimating(true);setTimeout(()=>{setStep(2);setAnimating(false);},350);}}
        >Next</button>
      </div>
      ...
      <div style={{
        ...
        <div style={{display:'flex',gap:8}}>
          <button
            ...
            onClick={()=>{setAnimating(true);setTimeout(()=>{setStep(1);setAnimating(false);},350);}}
          >Back</button>
          <button
            type="button"
            ...
            onClick={()=>{setAnimating(true);setTimeout(()=>{setStep(3);setAnimating(false);},350);}}
          >Next</button>
        </div>
      </div>
