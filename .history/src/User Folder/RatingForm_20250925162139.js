    ...
    try {
      ...
      if (programId.selected_dates && programId.selected_dates.length > 0) {
        try {
          ...
          const timestamps = programId.selected_dates.map(date => {
            ...
            console.log(`Converting date ${date} to timestamp: ${timestamp}`);
            return timestamp;
          });
        ...
        try {
          ...
          const timestamp = programId.start_date * 1000;
          console.log("Converting Unix timestamp:", timestamp);
