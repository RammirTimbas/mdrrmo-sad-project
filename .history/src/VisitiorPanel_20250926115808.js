        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50">
          <div className="fixed inset-0 bg-white">
            <div className="flex items-center justify-between p-4 sm:p-6 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
              <h2 className="text-2xl sm:text-3xl font-bold">Training Schedule</h2>
              <button
                onClick={() => setShowSchedule(false)}
                className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 hover:bg-white/20 transition-all duration-300 text-white"
              >
