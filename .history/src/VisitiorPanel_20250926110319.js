...
import Calendar from "./Admin Folder/utils/Calendar";
import "./App.css";
...
const VisitorPanel = ({ onLoginClick }) => {
  ...
  return (
    ...
    bg-[length:200%_200%] animate-gradient"
      ...
      <section className="w-full max-w-7xl mx-auto px-2 sm:px-6 mb-8 mt-6">
        <h2 className="text-xl sm:text-2xl font-bold text-blue-800 mb-4">Training Calendar</h2>
        <Calendar
          programs={trainingPrograms}
          mobile={isMobile}
          disableEventClick={isMobile}
        />
      </section>
