                                      ...
                                      {normalizedDates.map(dateStr => {
                                        ...
                                        return (
                                          <td
                                            ...
                                            className={`px-2 sm:px-4 py-3 capitalize cursor-pointer hover:bg-gray-100 ${status === "present"
      ...
      {showAttendanceModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-medium">Update Attendance</h3>
              <button
            ...
            <div className="mb-4">
              ...
              <p><span className="font-medium">Current Status:</span> <span className={`capitalize ${
                selectedAttendance.currentStatus === "present" ? "text-green-600" :
                selectedAttendance.currentStatus === "absent" ? "text-red-600" : "text-gray-400"
              }`}>{selectedAttendance.currentStatus}</span></p>
            </div>
